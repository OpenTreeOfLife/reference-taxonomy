...
## Build script
    ...
    otc-taxonomy-patcher \
      --demand-all-applied \
      --edits /work/opentree/edOTTs/edott-000001.json \
      --edits /work/opentree/edOTTs/edott-000002.json \
      --edits /work/opentree/edOTTs/edott-000003.json \
      --edits /work/opentree/edOTTs/edott-000004.json \
      --edits /work/opentree/edOTTs/edott-000005.json \
      --edits /work/opentree/edOTTs/edott-000006.json \
      --edits /work/opentree/edOTTs/edott-000007.json \
      --edits /work/opentree/edOTTs/edott-000008.json \
      /work/opentree/ott/ott3.2 \
      --write-taxonomy /work/opentree/ott/ott3.3 2>&1 | tee patch.log

with otcetera commit e4d3eeceae70a82677ef7be71d104ce4c264ed32
...
1.  Curated additions from the Open Tree amendments-1 repository as processed into https://github.com/OpenTreeOfLife/edOTTs 
  up to commit [1281c6afa4fa504af4b2f47d9965d16f6e1067d6](https://github.com/OpenTreeOfLife/edOTTs/commit/1281c6afa4fa504af4b2f47d9965d16f6e1067d6) These taxa are added during OTU mapping using the curator application.
