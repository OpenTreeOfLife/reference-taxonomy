...
* OTT identifiers ('taxa'): 4,528,224 
* Visible: 3,943,215 
* Synonyms: 2,225,600
...
## Build script
    ...
    otc-taxonomy-patcher \
      --demand-all-applied \
      --edits /work/opentree/edOTTs/edott-000009.json \
      --edits /work/opentree/edOTTs/edott-000010.json \
      /work/opentree/ott/ott3.3 \
      --write-taxonomy /work/opentree/ott/ott3.4 2>&1 | tee patch.log

with otcetera commit [2cacc9004b4a781d3c937f16278584f943d638ce](https://github.com/OpenTreeOfLife/otcetera/commit/2cacc9004b4a781d3c937f16278584f943d638ce)
...
1.  Curated additions from the Open Tree amendments-1 repository as processed into https://github.com/OpenTreeOfLife/edOTTs 
  up to commit [5bff4bc32a91a7c6e0541d94b71a0a9ae2fdda02](https://github.com/OpenTreeOfLife/edOTTs/commit/5bff4bc32a91a7c6e0541d94b71a0a9ae2fdda02) These taxa are added during OTU mapping using the curator application.
